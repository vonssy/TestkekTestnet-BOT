# Blockchain Testkek Testnet BOT
Blockchain Testkek Testnet BOT

- Dashboard Here : [Blockchain Testkek Testnet](https://swap.block-chain.lol/)
- Connect New Wallet
- Claim [BTC Faucet](https://faucet.block-chain.lol/)
...
## Features
  ...
  - Auto Wrap BTC to WBTC
  - Auto Unwrap WBTC to BTC
...
1. **Clone The Repositories:**
   ```bash
   git clone https://github.com/vonssy/TestkekTestnet-BOT.git
   ```
   ```bash
   cd TestkekTestnet-BOT
   ```
